    ...
    <section className="p-6 border rounded bg-white shadow dark:bg-dark-lite">
      ...
      <div className="flex flex-col md:flex-row items-center gap-20">
        <div className="w-full md:w-[40%]">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-5">
            ...
            <div>
              ...
              <input className="inputField cursor-not-allowed bg-gray-100 dark:bg-gray-800" placeholder="Email" {...register('email')} disabled />
            </div>
        ...
        <div className="mt-4 md:mt-0 flex items-center justify-center flex-col gap-4">
          <img referrerPolicy="no-referrer" className="w-52 h-52 border-2 border-solid border-color-accent rounded-full p-1 object-cover" src={user?.photoURL} alt="profile photo" />
