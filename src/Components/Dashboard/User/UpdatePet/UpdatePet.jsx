  ...
  useEffect(() => {
    if (!isLoading && pet) {
      setSelectedOption({
        ...
        label: pet.petCategories ? pet.petCategories.charAt(0).toUpperCase() + pet.petCategories.slice(1) : '',
      });
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <input type="text" defaultValue={pet?.petName} placeholder="Pet Name" {...register('petName', { required: 'Pet name is required.' })} className="inputField" />
              {errors.petName && (
            ...
            <div className="flex gap-4 flex-1">
              ...
              <div className="flex-1">
                <input type="number" placeholder="Pet Age" className="inputField" defaultValue={pet?.petAge?.value} {...register('petAge.value', { required: 'Pet age is required.' })} />
                {errors.petAge?.value && (
              ...
              <div>
                <select className="inputField" defaultValue={pet?.petAge?.unit} {...register('petAge.unit', { required: 'Pet age unit is required.' })}>
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <input type="text" defaultValue={pet?.petLocation} placeholder="Pet Location" {...register('petLocation', { required: 'Pet location is required.' })} className="inputField" />
              {errors.petLocation && (
                <p className="text-red-500 flex items-center gap-2">
          ...
          <div>
            <ReactQuill theme="snow" value={longDesc} onChange={setLongDesc} />
          </div>
