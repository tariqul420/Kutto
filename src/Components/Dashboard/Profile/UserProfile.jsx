  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6 flex flex-col items-center">
        ...
        <div className="items-center mt-4 grid grid-cols-12">
          ...
          <div className="ml-6 col-span-10">
            ...
            <p className="text-sm mt-2 text-gray-500 dark:text-gray-400">
              {user.bio ||
                "I believe in giving pets a loving home. I'm here to find my perfect furry companion or help others do the same. If you're looking for a new pet or want to share information about pets available for adoption, feel free to reach out!"}
            </p>
            <Link to={`/dashboard/settings`} className="mt-3 px-4 py-2 bg-color-accent text-white rounded-lg  items-center gap-2 inline-flex">
              <MdEdit /> Edit Profile
            </Link>
          </div>
        </div>
      ...
      <div className="w-full max-w-5xl mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <div className="bg-gray-200 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <a href="https://tariqul.vercel.app/" target="_blank" className="text-gray-700 dark:text-gray-300">
              tariqul.vercel.app
            </a>
          </div>
          <div className="bg-gray-200 dark:bg-gray-700 p-4 rounded-lg">
      ...
      <div className="w-full max-w-5xl mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <button onClick={() => toast.error('Feature Not Available')} className="mt-4 px-4 py-2 bg-red-500 text-white rounded-lg">
          Delete Account
        </button>
      </div>
    </div>
