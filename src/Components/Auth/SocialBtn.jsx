...
const SocialBtn = ({ redirectUrl }) => {
  ...
  return (
    <ul className="border-solid border-black text-3xl flex gap-8">
      <li onClick={handelFacebook} className="border cursor-pointer border-solid border-black dark:border-white p-1 rounded-full">
        <FaFacebook />
      </li>
      <li onClick={handelGoogle} className="border cursor-pointer border-solid border-black dark:border-white p-1 rounded-full">
        <FaGoogle />
      </li>
      <li onClick={handelGithub} className="border cursor-pointer border-solid border-black dark:border-white p-1 rounded-full">
        <FaGithub />
      </li>
    </ul>
  );
