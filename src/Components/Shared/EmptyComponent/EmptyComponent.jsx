...
const EmptyComponent = () => {
  ...
  return (
    <Empty className={`col-span-3 ${location.pathname.startsWith('/pets') && 'mb-6'}`}>
      ...
      <EmptyDescription className="mb-8">We couldn’t find any results for your search. Please try adjusting your search criteria or check back later.</EmptyDescription>
