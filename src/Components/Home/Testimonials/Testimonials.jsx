...
const reviewData = [
  ...
  },
  {
    name: 'Mark Johnson',
    image:
      'https://img.freepik.com/free-photo/close-up-portrait-young-hindu-man-isolated-real-emotions-male-model-mourning-mental-suffering-facial-expression-human-nature-emotions-concept_155003-23513.jpg?t=st=1736862441~exp=1736866041~hmac=0f538cba79dbc5b7ff56a666c55e6b245c8134ff87ab05d73caf16f23ebaa578&w=740',
  ...
  },
  {
    name: 'Sarah Lee',
    image:
      'https://img.freepik.com/free-photo/young-lady-with-deep-green-eyes-long-brown-hair_8353-1307.jpg?t=st=1736862489~exp=1736866089~hmac=2559345326715b249aa9d696bc639fb12246d6f83b8136fba2cbbbe5b3d5f278&w=740',
  ...
  return (
    <section className="w-full py-16">
      <div className="w-11/12 mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-gray-800 dark:text-white mb-8">Our Happy Customers</h2>
        <Swiper
          spaceBetween={30}
          slidesPerView={1}
          loop={true}
            ...
            <SwiperSlide key={index}>
              <div className="flex items-center bg-white dark:bg-dark-lite shadow-lg rounded-lg p-6">
                <div className="w-1/3 mr-6">
                  <img src={review.image} alt={`Customer ${review.name}`} className="w-44 max-sm:w-24 max-sm:h-24 h-44 rounded-full object-cover" />
                </div>
                <div className="w-2/3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{review.testimonial}</p>
                </div>
              </div>
            </SwiperSlide>
          ))}
