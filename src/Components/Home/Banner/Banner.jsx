      ...
      <CarouselSlides>
        {carouselData.map((slide, index) => (
          <CarouselItem key={index}>
            <div className="relative flex items-center rounded-xl h-[26rem] bg-cover bg-center" style={{ backgroundImage: `url(${slide.img})` }}>
              ...
              <div className="relative w-11/12 mx-auto text-center text-white z-10 space-y-4">
                ...
                <p className="text-lg">
                  Human shampoo for dogs after six days of delicate care. Ensure your pet’s <br /> happiness with quality grooming products.
                </p>
                <button onClick={() => navigate('/pet-listing')} className="bg-color-accent p-3 px-4 text-lg font-medium">
                  View More
                </button>
              </div>
            </div>
