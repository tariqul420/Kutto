...
const FAQ = () => {
  return (
    <section className="w-full py-16">
      <div className="max-w-6xl max-sm:w-11/12 mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start space-y-6">
            <div className="lg:ml-4 space-y-2">
              <h3 className="text-3xl font-semibold text-color-accent">FAQ Question</h3>
              <h2 className="text-4xl font-semibold">History & Family Adoption</h2>
            </div>
            <Accordion flush={true} type="single" collapsible>
              <AccordionItem value="value-1">
                <AccordionAction>
                  <AccordionTitle>Working for dog adoption</AccordionTitle>
                  <AccordionIcon />
                </AccordionAction>
                <AccordionContent>
              ...
              <AccordionItem value="value-2">
                <AccordionAction>
                  <AccordionTitle>Competitions & Awards</AccordionTitle>
                  <AccordionIcon />
                </AccordionAction>
                <AccordionContent>
                  The best overall dog DNA test is embark breed & health Kit (view atths Chewy), which provides you with a breed brwn and ition on provides ancestors most dogs.
              ...
              <AccordionItem value="value-3">
                <AccordionAction>
                  <AccordionTitle>The puppies are 3 mohths old</AccordionTitle>
                  <AccordionIcon />
                </AccordionAction>
                <AccordionContent>
                  The best overall dog DNA test is embark breed & health Kit (view atths Chewy), which provides you with a breed brwn and ition on provides ancestors most dogs.
