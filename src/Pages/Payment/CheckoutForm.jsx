  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <button type="submit" disabled={!stripe || loading} className={`bg-color-accent w-full  text-white font-medium px-6 py-2 rounded-md mt-6 ${loading && 'opacity-50 cursor-not-allowed'}`}>
