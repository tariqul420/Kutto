        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-5">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <input type="text" placeholder="Donation Name" className="inputField" {...register('donationName', { required: 'Donation name is required.' })} />
              {errors.donationName && (
          ...
          {/* Long Description */}
          <div>
            <ReactQuill theme="snow" value={longDesc} onChange={setLongDesc} className={longDescError ? 'border border-red-500' : ''} />
            {longDescError && (
              <p className="flex text-red-500 gap-1 items-center mt-1">
