  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        accessorKey: 'amount',
        header: 'Amount',
        cell: (info) => <p>$ {info.row.original.amount}</p>,
      },
      {
      ...
      },
      {
        ...
        cell: (info) => (
          <div className="flex gap-2 flex-wrap justify-center">
            <button className="bg-red-500 p-1 rounded-md text-white" onClick={() => handleRefund(info.row.original.donationId, info.row.original.amount)}>
