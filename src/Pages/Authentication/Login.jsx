      ...
      <section className="w-10/12 mx-auto h-auto flex flex-col-reverse max-sm:mb-8 lg:flex-row my-0 lg:my-12">
        ...
        <div className="shadow-md backdrop-blur-3xl rounded-lg sm:py-6 sm:px-8 p-4 flex flex-col gap-5 flex-1 dark:bg-dark-lite">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-5">
            <h3 className="text-[1.8rem] font-[700] text-center">Login</h3>

            {/* Email */}
            <div>
              <input type="email" name="email" placeholder="Email" className="inputField" {...register('email', { required: 'Email is required', onChange: (e) => setEmail(e.target.value) })} />
              {errors.email && (
            ...
            <div className="flex items-center justify-center w-full gap-1">
              <span className="text-[1rem] dark:text-gray-400 font-[500]">Don&apos;t have an account? </span>
              <span>
